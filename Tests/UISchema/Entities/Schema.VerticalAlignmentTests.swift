//
//  Schema.VerticalAlignmentTests.swift
//  AdaptyTests
//
...
private extension AdaptyUISchemaTests {
    @Suite("Schema.VerticalAlignment Tests")
    struct SchemaVerticalAlignmentTests {
        typealias Value = Schema.VerticalAlignment
...
private extension AdaptyUISchemaTests.SchemaVerticalAlignmentTests {
