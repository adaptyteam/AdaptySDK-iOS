//
//  Schema.Pager.PageControl.LayoutTests.swift
//  AdaptyTests
//
...
private extension AdaptyUISchemaTests {
    ...
    struct SchemaPagerPageControlLayoutTests {
...
private extension AdaptyUISchemaTests.SchemaPagerPageControlLayoutTests {
