...
extension ClockTests {
    struct AdaptyDurationTests {
        ...
        @Test func factories() {
            ...
            #expect(AdaptyDuration.seconds(1.5) == .milliseconds(1500))
            ...
            #expect(AdaptyDuration.milliseconds(1.5) == .microseconds(1500))
            #expect(AdaptyDuration.microseconds(1.5) == .nanoseconds(1500))
        ...
        @Test func timeIntervalConversion() {
            #expect(AdaptyDuration.milliseconds(1500).asTimeInterval == 1.5)
            #expect(AdaptyDuration.milliseconds(-1500).asTimeInterval == -1.5)
        }

        @Test func integerUnitConversions() {
            #expect(AdaptyDuration.milliseconds(1500).asSeconds == 1)
            #expect(AdaptyDuration.milliseconds(1500).asMilliseconds == 1500)
