...
extension AdaptyCodableTests {
    struct JsonExtractUnicodeUTF8Tests {
        ...
        @Test func valueEmojiPerCodePoint() throws {
            let codepoints: [(scalar: Unicode.Scalar, expected: String)] = try [
                (#require(Unicode.Scalar(0x1F44D)), "\u{1f44d}"),
                (#require(Unicode.Scalar(0x1F496)), "\u{1f496}"),
                (#require(Unicode.Scalar(0x1F4AC)), "\u{1f4ac}"),
                (#require(Unicode.Scalar(0x1F4C8)), "\u{1f4c8}"),
                (#require(Unicode.Scalar(0x1F4DD)), "\u{1f4dd}"),
                (#require(Unicode.Scalar(0x1F4FA)), "\u{1f4fa}"),
                (#require(Unicode.Scalar(0x1F514)), "\u{1f514}"),
                (#require(Unicode.Scalar(0x1F519)), "\u{1f519}"),
                (#require(Unicode.Scalar(0x1F525)), "\u{1f525}"),
                (#require(Unicode.Scalar(0x1F52F)), "\u{1f52f}"),
                (#require(Unicode.Scalar(0x1F573)), "\u{1f573}"),
                (#require(Unicode.Scalar(0x1F60A)), "\u{1f60a}"),
                (#require(Unicode.Scalar(0x1F642)), "\u{1f642}"),
                (#require(Unicode.Scalar(0x1F305)), "\u{1f305}"),
                (#require(Unicode.Scalar(0x1F381)), "\u{1f381}"),
                (#require(Unicode.Scalar(0x1F3AF)), "\u{1f3af}"),
                (#require(Unicode.Scalar(0x26A1)), "\u{26a1}"),
                (#require(Unicode.Scalar(0x272A)), "\u{272a}"),
            ]
