...
extension Adapty {
    ...
    public nonisolated static func getProfile() async throws -> AdaptyProfile {
    ...
    public nonisolated static func updateProfile(params: AdaptyProfileParameters) async throws {
