...
public extension Adapty {
    ...
    nonisolated static func updateProfile(params: AdaptyProfileParameters) async throws(AdaptyError) {
        try await withActivatedSDK(methodName: .updateProfile) { sdk throws(AdaptyError) in
