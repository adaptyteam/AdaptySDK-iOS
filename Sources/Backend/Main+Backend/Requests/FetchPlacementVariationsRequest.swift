...
private struct FetchPlacementVariationsRequest: BackendRequest {
    ...
    init<Content: PlacementContent>(
        ...
        if type == AdaptyFlow.self {
            ...
            requestName = .fetchFlowVariations
            logParams = [
...
extension Backend.MainExecutor {
    func fetchPlacementVariations<Content: PlacementContent>(
        ...
        let request = try FetchPlacementVariationsRequest(
            type,
    ...
    func preloadPlacementVariations<Content: PlacementContent>(
        _ type: Content.Type,
        apiKeyPrefix: String,
        userId: AdaptyUserId,
        placementId: String,
