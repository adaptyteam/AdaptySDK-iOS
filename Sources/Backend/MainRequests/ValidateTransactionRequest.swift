...
extension Backend.MainExecutor {
    ...
    func validateTransaction(
        ...
        let logParams: EventParameters = [
            ...
            "variation_id": purchasedTransaction.payload?.paywallVariationId,
            "variation_id_persistent": purchasedTransaction.payload?.persistentPaywallVariationId,
            "onboarding_variation_id": purchasedTransaction.payload?.persistentOnboardingVariationId,
