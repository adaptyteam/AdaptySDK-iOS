...
extension Schema.Localizer {
    ...
    private func elementProperties(_ from: Schema.Element.Properties) throws -> VC.Element.Properties? {
...
extension Schema.Element.Properties: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let opacity = if container.contains(.visibility) && !container.contains(.opacity) {
            ...
            try container.decodeIfPresent(Double.self, forKey: .opacity) ?? VC.Element.Properties.defaultOpacity
        }
        ...
        try self.init(
            ...
            padding: container.decodeIfPresent(VC.EdgeInsets.self, forKey: .padding) ?? VC.Element.Properties.defaultPadding,
            offset: container.decodeIfPresent(VC.Offset.self, forKey: .offset) ?? VC.Element.Properties.defaultOffset,
            opacity: opacity,
            onAppear: onAppear
        )
    }
