...
extension Adapty {
  ...
  public static func getPaywalls(
    forceUpdate: Bool
  ) async throws -> (paywalls: [PaywallModel]?, products: [ProductModel]?) {
    return try await withCheckedThrowingContinuation { continuation in
  ...
  ) async throws -> RestorePurchasesResult {
    return try await withCheckedThrowingContinuation { continuation in
  ...
  public static func getPurchaserInfo(
    forceUpdate: Bool = false
  ) async throws -> PurchaserInfoModel? {
    return try await withCheckedThrowingContinuation { continuation in
