...
extension AdaptyUICore.Element {
    var properties: AdaptyUICore.Element.Properties? {
        switch self {
        case .space:
            return nil
...
struct AdaptyUIElementWithoutPropertiesView: View {
    private var element: AdaptyUICore.Element
    ...
    @ViewBuilder
    private func elementOrEmpty(_ content: AdaptyUICore.Element?) -> some View {
        if let content {
