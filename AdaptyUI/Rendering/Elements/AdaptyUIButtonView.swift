...
struct AdaptyUIButtonView: View {
    ...
    private var button: AdaptyUICore.Button
    ...
    init(_ button: AdaptyUICore.Button) {
        self.button = button
    }

    private var currentStateView: AdaptyUICore.Element {
...
@available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
@MainActor
extension [AdaptyUICore.ActionAction] {
    func fire(
        screenId: String,
