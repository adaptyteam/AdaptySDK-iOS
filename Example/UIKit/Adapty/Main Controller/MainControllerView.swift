...
struct MainControllerView: View {
    ...
    @ViewBuilder func environmentsSection() -> some View {
//        Section {
//            ListSelectedItemView(title: "Development", selected: AppEnvironment.selectedEnvironment == .development) {
//                presenter.setEnvironment(.development)
//            }
//
//            ListSelectedItemView(title: "Production", selected: AppEnvironment.selectedEnvironment == .production) {
//                presenter.setEnvironment(.production)
//            }
//
//        } header: {
//            Text("Environment")
//        } footer: {
//            Text("Changing the environment will cause 'Logout' action")
//        }
